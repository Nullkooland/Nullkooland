...
namespace Nullkooland.Client.ViewModels.Pages
{
    public class SearchPageViewModel
    {
        ...
        public SearchPageViewModel(IThemeService themeService, IBlogPostService blogPostService)
        {
        ...
        public string PageTitle => $"Search - {_themeService.SiteTitle}";
